<?php
    ...
    $sql = "SELECT vpotensi.*, mahasiswa.nama, prodi.nama_prodi, tahun.thn as tahun_ppm FROM vpotensi LEFT JOIN mahasiswa ON mahasiswa.npm = vpotensi.npm LEFT JOIN prodi ON prodi.id = mahasiswa.id_prodi LEFT JOIN tahun ON tahun.id_thn = vpotensi.id_thn ";
    ...
    $sql .= " ORDER BY vpotensi.npm DESC";
