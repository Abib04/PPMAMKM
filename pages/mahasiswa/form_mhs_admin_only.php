...
<div class="row">
	<div class="col-xs-8" style="border-right: 1px solid #ddd; border-top: 1px solid #ddd; padding-top: 10px;">
        ...
        <div class="form-group">
        	...
        	<div class="row">
        		<div class="col-xs-3">
        			<input type="number" pattern="[0-9]" name="rw" min="0" class="form-control"" />
        		</div>
        		<div class="col-xs-3">
        			<input type="number" pattern="[0-9]" name="rt" min="0" class="form-control" />
        		</div>
        	</div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="kecamatan" class="form-control" required disabled />
        </div>
        <div class="form-group">
            <div class="row">
            	<div class="col-xs-3">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" row="3" name="alamat_yk"></textarea>
        </div>
        <div class="form-group" style="margin-top: 20px">
            <label for="slta_asal">Asal SLTA <i class="required">*</i></label>
            <input type="text" class="form-control" name="slta_asal" required />
        </div>
        <div class="form-group">
            <label for="hp">No. Telepon <i class="required">*</i></label>
            <input type="text" class="form-control" name="hp"  minlength="10"  maxlength="13" pattern="[0-9]{10,}" required />
        </div>
        <div class="form-group">
