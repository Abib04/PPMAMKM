			...
			<div class="row" style="height: 135px;background: #FFF;padding:0; border-top-left-radius:3em;border-top-right-radius:0.8em;">
				<div class="col-xs-9" style="padding-left: 0; padding-right: 0">
					<a href="http://kemahasiswaan.amikom.ac.id" target="_blank">
						<div style="background: transparent url(<?php echo base_url("resource/assets/images/header_web_ppm2024.webp"); ?>) no-repeat scroll 0% 0%; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; height: 135px; outline-color: rgb(255, 0, 0); outline-width: 1px; background-size:cover;border-top-left-radius: 0.8em;"></div>
					</a>
				</div>
				<div class="col-xs-3" id="student">
					...
					<form id="formlogin" method="post" action="<?php echo ($_SESSION['login'] == 1) ? rules("act_logout") : rules("act_login"); ?>">
						...
						?>
							...
							<label>Nomor Telp/Email akun CMHS</label>
							<input name="UserId" size="15" id="usr" class="usr" type="text" placeholder="Nomor Telp/Email CMHS">
							<label>Password akun CMHS</label>
							<input name="PassId" size="15" id="pwd" class="pwd" type="password">
							<br />
